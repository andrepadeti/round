      ...
      <div className="container">
        ...
        <div className="container-small">
          <div className="row row-cols-12">
            <p>
              Hoje eu quero voltar ao assunto de linguagem formal e informal. É
              muito importante escrever suas mensagens de email no registro
              correto para cada situação. Você está escrevendo para um cliente
              de longa data, ou um comprador entrando em contato com a empresa
              pela primeira vez? O email se destina a um colega de trabalho com
              quem você sai às vezes para jantar, ou o destinatário é alguém em
              um nível mais alto na hierarquia da empresa? Fatores como esses
              precisam ser levados em conta na hora de redigir uma mensagem.
            </p>
            <p>
              No exercício de hoje eu vou apresentar algumas frases em linguagem
              informal, e depois você precisa encontrar a frase equivalente em
              um linguagem mais formal.
            </p>
            <h3>Over to you</h3>
            <p>Look at these informal language sentences:</p>
            <p>
              <strong>a)</strong> We hope you are happy with this.{' '}
              <strong>b)</strong> Please answer asap. <strong>c)</strong> I'm
              sending you... <strong>d)</strong> We are working on your request.{' '}
              <strong>e)</strong> Thanks for your email/request.{' '}
              <strong>f)</strong> Can you help? <strong>g)</strong> Let us know
              if you need any more help. <strong>h)</strong> I'm sending you the
              ... in an attachment. <strong>i)</strong> Thanks for choosing...{' '}
              <strong>j)</strong> Can you please send me... ?
            </p>
            <p>
              Now match the informal sentences above to the more formal
              sentences below:
            </p>
            <figure>
